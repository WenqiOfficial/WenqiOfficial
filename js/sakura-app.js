  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/other/gravatar.webp');
      } else {
        ele.src = 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/other/default_avatar.webp';
      }
      break;
    case 2:
      ele.src = 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/other/default_gavatar.webp';
      break;
    case 3:

      ele.src = 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/other/image-404.webp';
      break;
    default:
      ele.src = 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/other/image-404.webp';
  }
...
function checkBgImgCookie() {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/sakura.png' || bgurl == 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/plaid.webp' || bgurl == 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/star.png' || bgurl == 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/point.png' || bgurl == 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/little-monster.webp') {
...
function checkEffectsCookie() {
  ...
  if (efurl) {
    ...
    effect.setAttribute("src", "https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/js/effect/sakura.js");
  ...
  if (efurl) {
    var effect = document.createElement("script");
    effect.setAttribute("src", "https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/js/effect/snow.js");
  ...
  if (efurl) {
    var effect = document.createElement("script");
    effect.setAttribute("src", "https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/js/effect/piao.js");
  ...
  if (efurl) {
    var effect = document.createElement("script");
    effect.setAttribute("src", "https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/js/effect/pointrain.js");
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/sakura.webp');
  changeBG('#gribs-bg', 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/plaid.webp');
  changeBG('#pixiv-bg', 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/star.webp');
  changeBG('#KAdots-bg', 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/point.webp');
  changeBG('#totem-bg', 'https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/themebg/little-monster.webp');
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true;
    mashiro_global.variables.isNight = true;
    $('body').css('background-image', 'url(https://raw.hubproxy.wenqi.icu/WenqiOfficial/wenqicdn/master/img/other/starry_sky.webp)');
...
function add_copyright() {
  document.body.addEventListener('copy', function (e) {
    if (!mashiro_global.is_user_logged_in && window.getSelection().toString().length > 10) {
      setClipboardText(e);
    }
  });
  ...
  Siren = {
    ...
    MJ: function () {
      if (mashiro_option.mathjax == '1') {
        $.getScript('//cdnjs.snrat.com/ajax/libs/mathjax/2.7.7/MathJax.js?config=TeX-MML-AM_CHTML', function () {
