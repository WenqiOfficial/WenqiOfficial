	...
	return function(e) {
		...
		function(e, t, n) {
			...
			var s = function() {
				...
				f = Object.getPrototypeOf || function(e) {
					return e.__proto__
				}, p = {}, d = "undefined" == typeof Uint8Array ? void 0 : f(Uint8Array),
				h = {
			...
			Array.prototype.forEach || (Array.prototype.forEach = function(e, t) {
				...
				default, {
					...
					dynamicLoadSource: function(e, t) {
						if ((0, s.
							...
							n.onload = n.onreadystatechange = function() {
								var e = this;
								e.onload = e.onreadystatechange = null, t && t(), (0, s.
									default)(n).remove()
					...
					sdkLoader: function(e, t, n) {
						t in window && window[t] ? (k && clearTimeout(k), n && n()) : s.
		...
		function(e, t, n) {
			...
			var o = function(e, t, n, r) {
				...
				return "a" === e && "class" == t && "at" === n ? t + "='" + i.
				default.escapeAttrValue(n) + "'" : "img" === e && /src|class/i.test(t) ? t + "='" + i.
				default.escapeAttrValue(n) + "' referrerPolicy='no-referrer'" : void 0
			}
		},
		function(e, t, n) {
			"use strict";
...
*/
		...
		function(e, t, n) {
			...
			i.prototype.init = function(e) {
				...
				var t = this;
				return e && (e = A.
					default.extend(h.CONFIG, e), t.i18n = (0, f.
						default)(e.lang || A.
						default.lang, e.langMode), t.cfg = e, d.
				...
				try {
					...
					if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
						e.$el = (0, A.
							default)(p), e.$el.addClass("v").attr("data-class", "v"), $.hide && e.$el.addClass("hide-avatar"), e.cfg.meta = (e.cfg.guest_info || e.cfg.meta || h.defaultMeta).filter(function(e) {
				...
				r.setPublicReadAccess(!0), r.setPublicWriteAccess(!0), n.setACL(r), n.set("url", t.url), n.set("xid", t.xid), n.set("title", t.title), n.set("time", 1), n.save().then(function(e) {
					...
					show: function(e, t) {
						...
						if (t.forEach(function(e) {
							...
							t && t.text("0"), n.push(/\%/.test((0, A.
								default)(e).attr("id")) ? decodeURI((0, A.
								default)(e).attr("id")) : (0, A.
								default)(e).attr("id"))
						}), n.length) {
			...
			i.prototype.Q = function(e) {
				...
				e.$emoji = {
					...
					show: function() {
						return O ? (e.$emoji.hide(), i.addClass("actived"), n.html((0, E.
							default)(O)).show(), R()) : e.$preview.hide(), e.$preview
					},
					hide: function() {
				...
				var f = function(t) {
					var r = t.val() || "";
					r || e.$preview.hide(), O != r && (O = r, i.hasClass("actived") > -1 && O != n.html() && n.html((0, E.
						default)(O)), R())
				};
					...
					v[t] = n, n.on("input change blur propertychange", function(r) {
						e.cfg.enableQQ && "blur" === r.type && "nick" === t && (n.val() && !isNaN(n.val()) ? (0, b.fetchQQFn)(n.val(), function(e) {
								var t = e.nick || n.val(),
									r = e.qq + "@qq.com";
								(0, A.
									default)(".vnick").val(t), (0, A.
										default)(".vmail").val(r), S.nick = t, S.mail = r, S.QQAvatar = e.pic
							}) : A.
							default.store.get(h.QQCacheKey) && A.
							default.store.get(h.QQCacheKey).nick != n.val() && (A.
								default.store.remove(h.QQCacheKey), S.nick = n.val(), S.mail = "", S.QQAvatar = "")), "comment" === t ? ((0, l.
							default)(n[0]), D(function(e) {
							f(n)
						})()) : S[t] = (0, C.
							default)(n.val().replace(/(^\s*)|(\s*$)/g, "").substring(0, 35))
					})
				}();
				var D = function(e) {
				...
				var j = function() {
					...
					return n.length > 0 ? n[0] : ""
                        ...
                        if(md5(t.get("mail"),32)==e.cfg.master){
                            var i = (0, A.
                                default)('<div class="vcard" id="' + t.id + '"></div>'),
                                o = (0, C.
                                    default)(t.get("ua")),
                                a = "";
                            o && !/ja/.test(e.cfg.lang) && (o = A.default.detect(o), a = o.version ? o.os ? '<span class="vsys">'+'<i class="fa fa-'+o.browser.toLowerCase()+'" aria-hidden="true" /></i> '+ o.browser + " " + o.version + '</span> <span class="vsys">'+'<i class="fa fa-'+o.os.toLowerCase().replace("ios","apple").replace("macos","apple")+'" aria-hidden="true" /></i> '+ o.os + " " + o.osVersion + '</span> <span class="vsys" style="color:#FF8C00">博主</span>' : '<span class="vsys" style="color:#FF8C00">博主</span>' : '<span class="vsys">' + o.browser + '</span> <span class="vsys" style="color:#FF8C00">博主</span>'), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                        }else{
                            var i = (0, A.
                                default)('<div class="vcard" id="' + t.id + '"></div>'),
                                o = (0, C.
                                    default)(t.get("ua")),
                                a = "";
                            o && !/ja/.test(e.cfg.lang) && (o = A.default.detect(o), a = o.version ? o.os ? '<span class="vsys">'+'<i class="fa fa-'+o.browser.toLowerCase()+'" aria-hidden="true" /></i> '+ o.browser + " " + o.version + '</span> <span class="vsys">'+'<i class="fa fa-'+o.os.toLowerCase().replace("ios","apple").replace("macos","apple")+'" aria-hidden="true" /></i> '+ o.os + " " + o.osVersion + "</span>" : "" : '<span class="vsys">' + o.browser + "</span>"), "*" === e.cfg.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                        }

                        var Emailavatar = $.cdn + (0, u.default)(t.get("mail")) + $.params;
                        if (t.get("mail").indexOf("@qq.com") >= 0) {
                            var qq_nub = t.get("mail").replace("@qq.com","").match(/[1-9]([0-9]{5,11})/);
                            if(qq_nub != null){
                                Emailavatar = "https://q.qlogo.cn/g?b=qq&nk="+qq_nub+"&s=640";
                            }
                        }
						...
						var s = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
							l = A.
						default.escape((0, C.
							default)(t.get("nick").substring(0, 30))), c = s ? '<a class="vnick" rel="nofollow" href="' + j(s) + '" target="_blank" >' + l + "</a>" : '<span class="vnick">' + l + "</span>", f = $.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? (0, C.
							default)('<img class="vimg" src="' + j(t.get("QQAvatar")) + '" referrerPolicy="no-referrer"/>') : '<img class="vimg" src="' + (Emailavatar) + '">', p = f + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, g.
							default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, E.
						...
						setTimeout(function() {
							try {
								e.cfg.mathjax && "MathJax" in window && "version" in window.MathJax && (/^3.*/.test(window.MathJax.version) && MathJax.typeset() || MathJax.Hub.Queue(["Typeset", MathJax.Hub, document.querySelector(".v")])), "renderMathInElement" in window && renderMathInElement((0, A.
									default)(".v")[0], {
									delimiters: [{
										left: "$$",
										right: "$$",
					...
					if (t = A.
						...
						for (var n in p)
							if (p.hasOwnProperty(n)) {
								var r = p[n];
								e.$el.find(".v" + r).val(A.
									default.unescape(t[r])), S[r] = t[r]
							}
					var i = A.
					default.store.get(h.QQCacheKey);
					S.QQAvatar = e.cfg.enableQQ && !! i && i.pic || ""
				}(), e.reset = function() {
					S.comment = "", v.comment.val(""), f(v.comment), v.comment.attr("placeholder", e.cfg.placeholder), I = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), O = "", l.
					default.update(v.comment[0])
				};
				var M = e.$el.find(".vsubmit"),
					L = function(t) {
						if (e.cfg.requiredFields.indexOf("nick") > -1 && S.nick.length < 1) return v.nick[0].focus(), void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
						...
						B = {}, S.comment = (0, C.
							default)(O), S.nick = S.nick || "Anonymous";
						var i = A.
						...
						A.
						default.store.set("vlx", Date.now()), M.attr({
							disabled: !0
						}), e.$loading.show(!0);
						...
						n.setACL(N()), n.save().then(function(t) {
							...
							try {
								I.rid ? T(t, (0, A.
									default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), T(t, e.$el.find(".vcards")), k.skip++), M.removeAttr("disabled"), e.$loading.hide(), e.reset()
							} catch (t) {
								(0, x.
									default)(e, t, "save")
							}
		...
		function(e, t, n) {
			...
			default = function(e, t) {
				...
				o ? t && t() : i.
				default.sdkLoader("//unpkg.com/leancloud-storage@3/dist/av-min.js", "AV", function(n) {
					var r = "https://",
						i = "",
						a = e.app_id || e.appId,
		...
		function(e, t, n) {
			...
			d.code = function(e, t) {
				return '<pre><code class="hljs language-' + t + '">' + (t && hljs.getLanguage(t) ? hljs.highlight(t, e).value : s.
					default.escape(e)) + "</code></pre>"
			}, i.marked.setOptions({
				renderer: "hljs" in window ? d : new i.marked.Renderer,
				highlight: function(e, t) {
					return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e).value : (0, a.
						default)(e)
				},
				gfm: !0,
				tables: !0,
...
*/
		...
		function(e, t) {
			e.exports = {
				...
				"code-100": "Valine 初始化失败，请检查AppId和AppKey.",
				"code-140": "今日 API 调用总次数已超过开发版限制.",
				"code-401": "未经授权的操作，请检查AppId和AppKey.",
				"code-403": "访问被API域名白名单拒绝，请检查安全域名设置."
			}
		},
		function(e, t) {
			e.exports = {
